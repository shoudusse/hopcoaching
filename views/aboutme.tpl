<section id="aboutme">
  ...
  <div class="aboutme-header">
    <div class="aboutme-intro"><span>Sorina Dumoulin</span><br>Coach Professionnelle<br>Partenaire de votre réussite</div>
  ...
  <div id="ref-id">
    <h3 class="main-heading">Mes références professionnelles</h3>
    <div id="ref-lists">
    <div class="ref-section">
    <h4>Entreprises</h4>
      <ul>
        <li>Air France Cargo</li>
        <li>Kuehne & Nagel</li>
